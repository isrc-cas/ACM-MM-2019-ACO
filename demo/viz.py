...
STANDARD_COLORS = [
    ...
    'WhiteSmoke', 'Yellow', 'YellowGreen', 'AliceBlue', 'Chartreuse', 'Aqua', 'Aquamarine', 'Azure', 'Beige', 'Bisque',
    ...
    'Salmon', 'Tan', 'HoneyDew', 'HotPink', 'IndianRed',
]

NUM_COLORS = len(STANDARD_COLORS)

try:
    FONT = ImageFont.truetype('/data7/lufficc/projects/rpc-detector/demo/arial.ttf', 36)
except IOError:
    FONT = ImageFont.load_default()
    quit()


def _draw_single_box(image, xmin, ymin, xmax, ymax, color='black', display_str=None, font=None, thickness=8):
