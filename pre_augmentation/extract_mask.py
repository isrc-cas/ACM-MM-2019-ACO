...
def extract(paths):
    for i, path in enumerate(paths):
        ...
        edges[(edges < (edges.mean() * 0.25)) & (edges < 0.1)] = 0
...
if __name__ == '__main__':
    ...
    for category in data['categories']:
        category_id_to_name[category['id']] = category['supercategory']

    output_dir = 'masks'
    compare_dir = 'masked_images'
    ...
    paths = glob.glob(os.path.join('train2019', '*.jpg'))
